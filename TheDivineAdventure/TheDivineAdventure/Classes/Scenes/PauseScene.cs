...
namespace TheDivineAdventure
{
    public class PauseScene : Scene
    {
        ...
        public PauseScene(SpriteBatch sb, GraphicsDeviceManager graph, Game1 parent) : base(sb, graph, parent)
        {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (mouseState.LeftButton == ButtonState.Pressed)
            {
                ...
                {
                    secondaryPauseMenu = new AnimatedSprite(439, 488, parent.pauseMenuSheet, 4, false);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            //draw menu
            _spriteBatch.Begin();
            _spriteBatch.Draw(parent.pauseMenu, Vector2.Zero, null, Color.White, 0, Vector2.Zero,parent.currentScreenScale, SpriteEffects.None, 0);
            //draw embers
